...
class List extends Component{
  ...
  edit = (data) =>{
    this.props.add(`编辑${data.ownerCode}`,<AppForm params={{id:data.id}} paramsUrl="/owner/detail" submitUrl="/owner/update" />);
  }

  add = ()=>{
    this.props.add('新增业主单位',<AppForm submitUrl="/owner/add" />);
  }
