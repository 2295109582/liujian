      ...
      <Spin spinning={spinning}>
        ...
        <div style={{  margin:"0 auto",width:" 1000px",fontFamily: "微软雅黑",padding:"20px"}} ref={el=>this.print=el}>
            <div style={{textAlign:'center'}}>
              ...
              <h3 style={{fontSize:"22px",fontWeight:"bold",padding:'0 0 20px 0',margin:0}}>工程现金报销单</h3>
            </div>
            <table border="1"
              style={{
                width: "90%",
              ...
              <tbody>
               ...
               <td width="25%">{info.appDate}</td>
                 <td width="25%">附件张数</td>
               <td width="25%">{info.attachcount}</td>
               </tr>
               <tr>
                 <td >报销费用类别</td>
               <td colspan="3">{window.uc.getDic("reim_sort",info.reimSort)}</td>
               </tr>
               <tr>
                 <td >领款人账号</td>
