      ...
      <Spin spinning={spinning}>
        ...
        <div style={{  margin:"0 auto",width:" 1000px",fontFamily: "微软雅黑",padding:"20px"}} ref={el=>this.print=el}>
            <div style={{textAlign:'center'}}>
              ...
              <h3 style={{fontSize:"22px",fontWeight:"bold",padding:'0 0 20px 0',margin:0}}>工程领用支票申请单（非材料类）</h3>
            </div>
            <table border="1"
              style={{
                width: "90%",
              ...
              <tbody>
                ...
                <tr>
                   <td width="25%">用款时间</td>
                   <td width="25%" colSpan='2'>{info.appDate}</td>
                   <td width="25%">垫资额</td>
                   <td width="25%" colSpan='2'>{info.advancePay}</td>
                 </tr>
                 <tr>
                   <td >请款用途</td>
                 <td colSpan="5">{window.uc.getDic("pay_content",info.costSort)}</td>
                 </tr>
                 <tr>
                   <td >银行账号</td>
                 <td colSpan="5">{info.bankNo}</td>
                 </tr>
                 <tr>
                   <td>用款金额</td>
                    <td colSpan="4">
